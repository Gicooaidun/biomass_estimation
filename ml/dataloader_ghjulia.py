...
NODATAVALS = {'S2_bands' : 0, 'CH': 255} # TODO CHANGE THIS
...
class GEDIDataset(Dataset):
    ...
    def __init__(self, paths, fnames, chunk_size, mode, args):
        ...
        self.ch = args.ch # TODO CHANGE THIS
    ...
    def __getitem__(self, n):
        ...
        # CH data
        if self.ch: # TODO CHANGE THIS BLOCK
...
if __name__ == '__main__' :
    ...
    args.ch = True # TODO CHANGE THIS
    args.patch_size = [15,15]
    args.norm_strat = 'pct'
    args.norm = False

    fnames = ['data_subset-2019-v3_0-20.h5'] # TODO CHANGE THIS
